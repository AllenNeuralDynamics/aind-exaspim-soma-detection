...
--netG unet_deconv --netG_B deep_linear_gen --netD basic --gan_mode lsgan \
--init_type kaiming --norm instance --batch_size 8 \
--lambda_A 10 --crop_size 108 108 108 --display_histogram  --lambda_plane 1 1 1 \
--save_by_iter --save_latest_freq 500 --lr_policy constant --randomize_projection_depth --projection_depth 20
```
...
--name 20241001-2116_axial_to_lateral_gan_apollo --serial_batches \
--preprocess normalize_addColorChannel --dataset_mode diceImage \
--netG unet_deconv --data_name test_exaspim_685221 \
--gpu_ids 0 --overlap 32 --dice_size 120 120 120 \
--image_dimension 3 --model_suffix _A --save_volume --border_cut 10 --load_iter 16000
```

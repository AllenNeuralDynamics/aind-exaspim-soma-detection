...
class AxialToLateralGANDryopsModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            self.optimizer_D = torch.optim.Adam(
                itertools.chain(
                    self.netD_A_axial.parameters(), self.netD_A_lateral.parameters()
                ),
                lr=opt.lr,
    ...
    def optimize_parameters(self):
        ...
        self.set_requires_grad(
            [self.netD_A_lateral, self.netD_A_axial], False
        ...
        # D_A
        self.set_requires_grad([self.netD_A_lateral, self.netD_A_axial], True)

    ...
    for epoch in range(
        ...
        for i, data in enumerate(dataset):  # inner loop within one epoch
            ...
            if total_iters % opt.display_freq == 0:  # display images on tensorboard
                ...
                epoch_count = (
                    epoch - 1
                ) * 100  # display the progress in percent: for example 30% past two epochs is 230.
                visualizer.display_current_results(
                    model.get_current_visuals(), epoch_count + epoch_progress
                )
            ...
            if (
                ...
                visualizer.print_current_losses(
                    epoch, epoch_progress, losses, t_comp, t_data
                )

                if opt.display_id > 0:
                    visualizer.plot_current_losses(
                        epoch_count + epoch_progress, losses, is_epoch=False
                    )
            ...
            if (
                ...
                print(
                    "saving the latest model (epoch %d, epoch_progress %d%%)"
